...
function RegisterBGMI () {
    ...
    function handleSubmit(event)
    {
        ...
        // axios.post("http://localhost:8080/bgmi-register", {addData})
        // .catch(error => { console.log("Error sending Form Details: ", error) });

        axios.post("https://esports-server.onrender.com/bgmi-register", {addData})
        .catch(error => { console.log("Error sending Form Details: ", error) });
    ...
    {
        var gamename = "BGMI", direct = "/bgmi-points-table";
        ...
        <div>
            ...
            <Form onSubmit={handleSubmit} method="post" autocomplete="off">
                <div className="registrations">
                    ...
                    {status && <a className="start-btn" href="/bgmi-team">Bgmi Team</a>}
                    ...
                    <p className="reg-text">Team Registration Form </p>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="formHorizontalEmail">
                        ...
                        <Col sm={9}>
                        <Form.Control className='form-inputt' type="text" placeholder="" name="Wnum" value={addData.Wnum} onChange={handleChange} />
                        </Col>
                    </Form.Group>
                    ...
                    <Row xs={1} md={2} className="g-3">
                        ...
                        <Col className='reg-playerx'>
                            ...
                            <Form.Control className="form-input2" type="text" placeholder="Name" name="P2name" value={addData.P2name} onChange={handleChange} />
                            <Form.Control className="form-input2" type="text" placeholder="Roll No. " name="P2roll" value={addData.P2roll} onChange={handleChange} />
                            <Form.Control className="form-input2" type="text" placeholder="ID" name="P2id" value={addData.P2id} onChange={handleChange} />
                        </Col>
                        <Col className='reg-playerx'>
                            <p className='reg-p'>Player-3 : </p>
                            <Form.Control className="form-input2" type="text" placeholder="Name" name="P3name" value={addData.P3name} onChange={handleChange} />
                            <Form.Control className="form-input2" type="text" placeholder="Roll No. " name="P3roll" value={addData.P3roll} onChange={handleChange} />
                            <Form.Control className="form-input2" type="text" placeholder="ID" name="P3id" value={addData.P3id} onChange={handleChange} />
                        </Col>
                        <Col className='reg-playerx'>
                            <p className='reg-p'>Player-4 : </p>
                            <Form.Control className="form-input2" type="text" placeholder="Name" name="P4name" value={addData.P4name} onChange={handleChange} />
                            <Form.Control className="form-input2" type="text" placeholder="Roll No. " name="P4roll" value={addData.P4roll} onChange={handleChange} />
                            <Form.Control className="form-input2" type="text" placeholder="ID" name="P4id" value={addData.P4id} onChange={handleChange} />
                        </Col>
                    </Row>
